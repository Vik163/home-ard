const char *ntpServers[] = {"nl.pool.ntp.org", "be.pool.ntp.org", "de.pool.ntp.org"};
...
void ntp_setup(bool waitforsync)
{
   ...
   if (waitforsync && time_to_jurassic())
      Serial.println("Error setting time to long long ago");
